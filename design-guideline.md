...
- Provide a compact pill-style language dropdown with a clear “文A” bilingual marker beside the matching pill-style theme switch outside the navigation. Default to the system preference and persist explicit choices locally.
...
- Add a compact “Recommended in Mainland China” badge beside the local-installation title; use a solid theme-aware black or white border and interior.
