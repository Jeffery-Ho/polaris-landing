...
At 7, 28, and 90 days after submission, record impressions, clicks, CTR, and average position for:

- `Polaris AI`
- `Polaris AI Navigator`
- `AI chat navigator`

Treat improved impressions and association with the Chrome extension as progress. Do not treat immediate first-page ranking for the contested generic query `Polaris AI` as an acceptance criterion.
