...
- 修复：Runner 安装脚本会探测旧版 `curl` 是否支持 `--retry-all-errors`，兼容 Alibaba Cloud Linux 的系统版本。
...
- 页面：Header 下方新增居中的当前支持平台横幅，标题使用普通字重，平台使用半角逗号分隔并同步 Polaris-for-Web README 的 9 个平台；语言入口改为带胶囊外框的翻译图标，并沿用主题规范颜色，图标上移 1px 与语言文字视觉居中；导航新增“更新记录”入口，并在赞赏区下方以安装教程同款卡片同步 Polaris 功能版本记录，默认展示最新 5 条，可展开全部并在底部收起。
