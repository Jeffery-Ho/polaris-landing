...
- 页面：Header 下方新增居中的当前支持平台横幅，标题使用普通字重，平台使用半角逗号分隔并同步 Polaris-for-Web README 的 9 个平台；语言入口改为带胶囊外框的紧凑“文A”标识，与主题切换控件保持一致；导航新增“更新记录”入口，并在赞赏区下方以安装教程同款卡片同步 Polaris 功能版本记录，默认展示最新 5 条，可展开全部并在底部收起。
