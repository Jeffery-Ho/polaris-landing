...
- The ZIP action uses the GitHub [latest Release](https://github.com/Jeffery-Ho/Polaris-for-Web/releases/latest/download/Polaris-AI.zip) alias and requests the fixed `Polaris-AI.zip` asset; each archive contains a root `manifest.json`.
